...
export default function SignIn() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // La vérification se fait maintenant côté serveur via Supabase Auth
    // (le mot de passe ne quitte jamais le navigateur en clair, il est envoyé en HTTPS
    // directement à Supabase qui le compare au hash stocké — le front ne voit jamais la liste des comptes)
