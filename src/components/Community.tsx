...
export default function Community() {
  ...
  const renderProfileEditor = () => (
    <motion.section
      ...
      className="mb-5 overflow-hidden rounded-3xl border border-indigo-100 bg-white shadow-sm"
    >
      <form onSubmit={handleSaveProfile} className="p-5 md:p-7">
        <div className="flex flex-col gap-4 border-b border-slate-100 pb-5 md:flex-row md:items-start md:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-wider text-indigo-600">Profil public</p>
            <h2 className="mt-1 text-2xl font-black text-slate-900">Construisez votre identité professionnelle</h2>
